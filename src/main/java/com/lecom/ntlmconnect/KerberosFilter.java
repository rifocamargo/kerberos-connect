...
public class KerberosFilter extends GenericFilterBean {
        ...
        if (header != null && (header.startsWith("Negotiate ") || header.startsWith("Kerberos "))) {
            ...
            try {
            	...
            	if (e.getCause() instanceof TokenException) {
            		...
            		response.addHeader("WWW-Authenticate", "Negotiate " + new sun.misc.BASE64Encoder().encodeBuffer(te.getResponseToken()).replaceAll("\r\n", ""));
